...
n1=str(input("Enter player's 1 name:"))
n2=str(input("Enter player's 2 name:"))
...
while True:
    ...
    chosen_card2 = player2.draw_card(deck2, chosen_number2)
    ...
    if(chosen_card1!=chosen_card2):
        print("you intered diffret card ")
    else:
        print("you both winner and lucky winner")
        break
